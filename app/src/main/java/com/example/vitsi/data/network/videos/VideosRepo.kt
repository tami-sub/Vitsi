...
import com.example.vitsi.domain.TheResult
...
interface VideosRepo {
     ...
     * @return A custom result containing a list of {@link [com.example.vitsi.domain.audio.RemoteAudio]}
     */
    suspend fun fetchRandomAudios(): TheResult<List<RemoteAudio>>
     ...
     */
    suspend fun fetchAudio(audioId: String): TheResult<RemoteAudio?>
